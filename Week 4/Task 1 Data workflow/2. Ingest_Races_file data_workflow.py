...
.option("header", True) \
.schema(races_schema) \
.csv("/mnt/fformula1dl/raw/races.csv")
...
races_selected_df.write.mode('overwrite').partitionBy('race_year').parquet('/mnt/fformula1dl/processed/races')

# COMMAND ----------

# MAGIC %fs
# MAGIC ls /mnt/fformula1dl/processed/races
